      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <span className="text-gray-600 dark:text-gray-400">{script.language}</span>
            <span className="text-gray-400 dark:text-gray-500">|</span>
            <span className="text-gray-600 dark:text-gray-400">{script.pageCount} pages</span>
            <span className="text-gray-400 dark:text-gray-500">|</span>
            <span className="text-gray-600 dark:text-gray-400">{formatDate(script.createdAt)}</span>
          </div>

          <h1 className="text-3xl font-bold text-black dark:text-white mb-4">{script.title}</h1>

          {/* Copyright Badge */}
          {script.copyright.hasCertificate && (
            <div className="inline-flex items-center gap-1 px-3 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full text-sm mb-4">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
              ...
              <span className="font-medium">Copyright Protected</span>
              {script.copyright.certificateNumber && (
                <span className="text-green-600 dark:text-green-400">• {script.copyright.certificateNumber}</span>
              )}
            </div>
          )}
        </div>
        ...
        {/* Reactions & Stats */}
        <div className="flex flex-wrap items-center gap-6 py-4 border-y border-gray-200 dark:border-gray-800 mb-6">
          <LikeDislikeButtons
        ...
        {script.pdfUrl ? (
          ...
          <div className="w-full bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-500 font-semibold py-3 px-6 rounded-lg text-center mb-6">
        ...
        <div className="mb-6 p-4 bg-gray-100 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-lg font-medium text-black dark:text-white">{script.writer.name}</p>
